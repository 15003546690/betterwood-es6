	...
	var City = function () {
	    ...
	    _createClass(City, [{
	        ...
	        value: function getAlphabet() {
	            var _ref = [this.data.cityList, [], {}],
	                data = _ref[0],
	                alphabet = _ref[1],
	                alphaobj = _ref[2];

	            data.forEach(function (v, i) {
	                var upperAlpha = v[1].charAt(0).toUpperCase();
